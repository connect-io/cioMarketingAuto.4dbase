...
Function newScenario($nom_t : Text; $condition_o : Object)->$return_b : Boolean
	...
	$caScenario_o.configuration:=New object:C1471("companyNameInPersonList"; False:C215; "multipleAffectation"; False:C215; "type"; "Standard"; "nbErreurMaxExecution"; 3)
...
Function loadImageScenarioConfiguration
	...
	This:C1470.imageMultipleAffectation:=Storage:C1525.automation.image["toggle-off"]
	...
	If (This:C1470.scenarioDetail.configuration.multipleAffectation#Null:C1517)
		
		If (This:C1470.scenarioDetail.configuration.multipleAffectation=True:C214)
			This:C1470.imageMultipleAffectation:=Storage:C1525.automation.image["toggle-on"]
		End if 
...
Function newScene($nom_t : Text; $action_t : Text)->$return_b : Boolean
	...
	$caScene_o.paramAction:=New object:C1471("sauvegardeWritePro"; False:C215; "echelleDelai"; "minute(s)"; "modele"; New object:C1471("email"; New object:C1471("version"; New collection:C1472); "sms"; New object:C1471("version"; New collection:C1472); "courrier"; New object:C1471("version"; New collection:C1472)); \
