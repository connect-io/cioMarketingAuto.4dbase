...
If (Application type:C494#4D Remote mode:K5:5)
	MESSAGE:C88("Arrêt du serveur web..."+Char:C90(Carriage return:K15:38))
	WEB STOP SERVER:C618
	
	MESSAGE:C88("Chargement de l'application web..."+Char:C90(Carriage return:K15:38))
	$0.serverStart()
	
	MESSAGE:C88("Redémarrage du serveur web..."+Char:C90(Carriage return:K15:38))
