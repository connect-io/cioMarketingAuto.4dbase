...
------------------------------------------------------------------------------*/
#DECLARE($service_o : Object; $office365_cs : cs:C1710.NetKit.Office365)

var $credential_o : Object
...
$credential_o:=New object:C1471
$credential_o.name:="Microsoft"
$credential_o.permission:="service"

$credential_o.clientId:=$service_o.login  // Application (client) ID
$credential_o.clientSecret:=$service_o.password  // VALUE du client secret
$credential_o.tenant:=$service_o.token  // GUID du tenant OU "ton-tenant.onmicrosoft.com"

// Scope Graph en mode service : utilisera les Application permissions cochées sur l’app
$credential_o.scope:=$service_o.url

// (Optionnel) timeout HTTP vers login.microsoftonline.com
$credential_o.timeout:=30  // secondes

// 2) Création du provider OAuth2 (classe cs.NetKit)
var $oAuth2 : cs:C1710.NetKit.OAuth2Provider:=cs:C1710.NetKit.OAuth2Provider.new($credential_o)
...
$office365_cs:=cs:C1710.NetKit.Office365.new($oAuth2; {mailType: "JMAP"})  // Format avec les entete SMTP 4D.
$office365_cs.mail.userId:=$service_o.eMail
